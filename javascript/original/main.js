window.onload = function () {
  ...
  oBtAdd.onclick = function () {
		...
		inputObject = {content: context.content, deadline: context.deadline, isCheck: false, isDelete: false};
		...
		function clickoXIcon() {
			var deleteItem =	storageArray.find(function(obj){
			...
			storageArray = storageArray.filter(function(e){
